...
if(isset($_POST["edit_akun"])){
    ...
    if(edit_akun($_POST) > 0 ) {
        echo "<script>
            alert('Akun Berhasil Diubah!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }else{
        echo "<script>
            alert('Akun Berhasil Diubah!'); document.location.href='../admin/daftar_subjek.php';
...
if(isset($_POST["edit_password"])){
    ...
    if(edit_password($_POST) > 0 ) {
        echo "<script>
            alert('Passowrd Berhasil Diubah!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }else{
        echo "<script>
            alert('Passowrd Berhasil Diubah!'); document.location.href='../admin/daftar_subjek.php';
...
if(isset($_POST["tambah_subjek"]) ) {
    if(tambah_subjek($_POST) > 0 ) {
        // $berhasil_dihapus = true;
        echo "<script>
            alert('Subjek Berhasil Ditambahkan!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }else{
        // $gagal_dihapus = true;
        echo "<script>
            alert('Subjek Gagal Ditambahkan!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }
}
if(isset($_POST["edit_subjek"]) ) {
    if(edit_subjek($_POST) > 0 ) {
        // $berhasil_dihapus = true;
        echo "<script>
            alert('Subjek Berhasil Diubah!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }else{
        // $gagal_dihapus = true;
        echo "<script>
            alert('Subjek Gagal Diubah!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }
}
if(isset($_POST["hapus_subjek"]) ) {
    if(hapus_subjek($_POST) > 0 ) {
        // $berhasil_dihapus = true;
        echo "<script>
            alert('Subjek Berhasil Dihapus!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }else{
        // $gagal_dihapus = true;
        echo "<script>
            alert('Subjek Gagal Dihapus!'); document.location.href='../admin/daftar_subjek.php';
        </script>";
    }
}
        ...
        <div class="col col-lg-2 col-md-0 col-0 sidebar">
            ...
            <div class="row"> 
                <div class="col-lg-6 col-md-6 col-6 text-start">
                    <h4 class="fw-bold ">Daftar Subjek</h4>
                </div>
                <div class="col-lg-6 col-md-6 col-6 text-end">
                    <button type="submit" class="btn btn-success text-white rounded-pill" data-bs-toggle="modal" data-bs-target="#ModalTambah">Tambah Subjek</button>
                </div>
            </div>
            <hr>  
                <div class="table-responsive">
                    <table id="table"  class="table table-hover">
                        ...
                        <?php foreach( $subjek as $row)  : ?>
                            <tr>
                                <td><?= $i;?></td>    
                                <td><?= $row['nama_subjek'];?></td>
                                <td><img src="../gambar/ikon_subjek/<?php echo $row['ikon_subjek'];?>"  class="img-fluid rounded" width="50"></td>
                                <td> 
                                    <button type="button" class="btn btn-outline-primary btn-sm mb-1 mt-1"  data-bs-toggle="modal" data-bs-target="#ModalEdit<?= $row["id_subjek"]?>">
                                        <i class="bi bi-search"></i> Kelola Subjek
                                    </button>
                                    <button type="submit" class="btn btn-outline-danger btn-sm mb-1 mt-1" data-bs-toggle="modal" data-bs-target="#ModalHapus<?= $row["id_subjek"]?>">
                                        <i class="bi bi-trash"></i> Hapus Subjek
                                    </button>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                            <div class="modal fade text-start" id="ModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <?php include('../modal/modal_tambah_subjek.php'); ?>
                                            </div>
                                    </form>
                                    <!-- Modal Kelola Buku -->
                                    <form action="" method="post" enctype="multipart/form-data">
                                            <div class="modal fade text-start" id="ModalEdit<?= $row["id_subjek"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <?php include('../modal/modal_edit_subjek.php'); ?>
                                            </div>
                                    </form>
                                    <!-- Modal Hapus Artikel -->
                                    <form action="" method="POST">
                                        <div class="modal fade" id="ModalHapus<?= $row["id_subjek"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered ">
                                                <div class="modal-content">
                                                    <div class="modal-header text-center">
                                                        <h5 class="modal-title" id="exampleModalLabel">Anda yakin untuk menghapus Subjek <i><?= $row["nama_subjek"]?></i> ?</h5>
                                                    </div>
                                                    <form action="" method="post" enctype="multipart/form-data">
                                                    <div class="modal-body text-center">
                                                        <input type="text" hidden class="form-control" name="id_subjek" value="<?= $row["id_subjek"]?>"> 
                                                    <div class="row justify-content-end">
                                                        ...
                                                        <button type="submit" class="btn btn-danger text-white rounded-pill" name="hapus_subjek">Hapus</button>
                                                        </div>
                                                    </div>
                                                    </form>
                                                </div>
