<div class="modal-dialog modal-dialog-centered ">
        ...
        <!-- Modal Header -->
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ubah Password Akun <b><?= $row["username"]?></b></h1>
        ...
        <!-- Modal Footer -->
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary rounded-pill" name="admin_edit_password">Simpan</button>
            </div>
        </div>
    </div>